...
namespace ge {
	...
	public:
		...
		void add_write(uint32_t set, uint32_t index, uint32_t binding_index, VkImageView view, VkSampler sampler = nullptr, VkImageLayout layout = VK_IMAGE_LAYOUT_GENERAL);
